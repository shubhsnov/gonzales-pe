...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getArguments() {
	  ...
	  while (pos < tokensLength && tokens[pos].type !== TokenType.RightParenthesis) {
	    ...
	    } else if (checkClass(pos)) content.push(getClass());else {
	      throwError(pos);++pos;
	    } //PATCH
	  }
	...
	function getBlock() {
	  ...
	  while (pos < end) {
	    if (checkBlockdecl(pos)) content = content.concat(getBlockdecl());else {
	      throwError(pos);++pos;
	    } //PATCH
	  }
	...
	function getFunction() {
	  ...
	  var line = token.ln;
	  var column = token.col;
	  var content = []; //PATCH handle the case where function has space between name and argument
